...
call sf org create scratch -a OEE-EDA-Base-Unlocked__dev -f orgs/dev.json -w 10

REM Set newly created scratch org as default org.
call sf config set target-org OEE-EDA-Base-Unlocked__dev

REM Import newly created org into CCI for setup commands.
start "CCI Import" /wait /b cci org import OEE-EDA-Base-Unlocked__dev dev
